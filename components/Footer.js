      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between">
          <div className="mb-8 sm:mb-0">
            ...
            <p className="mt-2 text-base text-gray-500">
              Student Discount Program by Nucleus Diagnostics Centre
            </p>
            <p className="mt-1 text-sm text-gray-500">
              Get 30% off on all medical services with verified student ID
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 lg:gap-20">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li className="text-base text-gray-500">
                  Email: info@nucleusdiagnosticscentre.com
                </li>
                <li>
                  <a 
                    href="https://nucleusdiagnosticscentre.com" 
                    target="_blank" 
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            © {new Date().getFullYear()} Nucleus Diagnostics Centre. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
